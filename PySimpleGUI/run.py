...
class SimpleGUI():
    ...
    def inputFilenameLayout(self,displayImage):
        layout = [
                    [displayImage],
    ...
    def __init__(self):
        browseWindow = sg.Window("Select Files", self.selectFilesLayout())
        ...
        inputWindow = sg.Window("[{}/{}] Please Input - {}".format(1, len(fileList), fileList[0]),
                                self.inputFilenameLayout(displayImage))
